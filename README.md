...
## App Preview (UX Walkthrough)
- **Auth:** dark glass card login/signup with neon gradient CTA.
- **Home Dashboard:** welcome header, notification bell badge, KPI cards, and recent activity timeline.
- **Clients:** searchable list with status chips (All/Active/Inactive), inline edit, status toggle, and delete.
- **Tasks:** card-based board grouped by Pending / In Progress / Done with quick status actions.
- **Daily Work Panel:** animated floating panel showing today’s tasks.
- **Settings:** profile summary and logout.
